...
const colorModes = [
  ...
  { name: "Violet", value: "violet", icon: Leaf },
];
...
const gradients = [
  ...
  },
  {
    name: "New",
    value: "new",
    gradient: "linear-gradient(to top left,#A445B2,#D41872,#FF0066)",
  },
];
...
export default function Theme() {
  ...
  const handleThemeChange = (newTheme) => {
    ...
    if (newTheme === "violet") {
      ...
      root.classList.add("dark"); // Optional: if you want dark mode styling
    } else if (colorModes.map((mode) => mode.value).includes(newTheme)) {
  ...
  const CurrentModeIcon =
    colorModes.find((mode) => mode.value === currentMode)?.icon || Sun;
...
//     const currentTheme = currentClasses.find((cls) =>
